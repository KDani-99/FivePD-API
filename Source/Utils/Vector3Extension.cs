...
namespace FivePD.API.Utils
{
    ...
    public static class Vector3Extension
    {
        ...
        /// <returns></returns>
        public static Vector3 Around(this Vector3 pos, float radius) => pos + (RandomXy() * radius);
        ...
        /// </summary>
        public static float DistanceTo(this Vector3 source, Vector3 target) => World.GetDistance(source, target);

        /// <summary>
        /// Returns the provided offset added to this position
        /// </summary>
        public static Vector3 ApplyOffset(this Vector3 source, Vector3 offset) => new Vector3(source.X + offset.X, source.Y + offset.Y, source.Z + offset.Z);

        /// <summary>
        /// Returns the height of the ground at this position
        /// </summary>
        public static float GroundHeight(this Vector3 source) => World.GetGroundHeight(source);

        /// <summary>
        /// Returns the street name at this position
        /// </summary>
        public static string ClosestStreetName(this Vector3 source) => World.GetStreetName(source);

        /// <summary>
        /// Sets the player's waypoint to this position
        /// </summary>
        public static void SetWaypointHere(this Vector3 source) => World.WaypointPosition = source;

        /// <summary>
        /// Returns the closest location relative to this position, that a ped can be placed on the side walk
        /// </summary>
        public static Vector3 ClosestPedPlacement(this Vector3 source) => World.GetNextPositionOnSidewalk(source);
        ...
        public static Vector3 ClosestParkedCarPlacement(this Vector3 source, bool unoccupied = true) => World.GetNextPositionOnStreet(source, unoccupied);

        /// <summary>
        /// Returns the closest parked car relative to this position
        /// </summary>
        public static Vehicle GetClosestParkedCar(this Vector3 source)
        {
        ...
        /// <summary>
        /// Returns the WorldZone of the location provided
        /// </summary>
